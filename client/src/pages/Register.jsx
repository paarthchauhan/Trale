  ...
  return (
    <div className='w-full h-[100vh] bg-bgColor flex items-center justify-center p-6 2xl:py-10'>
      <div className='w-full md:w-2/3 h-fit lg:h-full 2xl:h-full py-8 lg:py-0 flex flex-row-reverse bg-primary rounded-xl overflow-hidden shadow-xl'>
        ...
        {/* RIGHT */}
        <div className='hidden w-1/2 h-full lg:flex flex-col items-center justify-center' style={{ backgroundColor: '#BF8F8F' }}>
          ...
          <p className='text-white text-base' style={{color: '#000000'}}>
            Not your everyday social media app
          </p>
          <span className='text-sm text-white/80' style={{color: '#000000'}}>
            Take social media into your hands.
          </span>
        </div>
        </div>
      </div>
